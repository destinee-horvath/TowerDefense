...
public class ButtonUpgradeDamage extends Buttons {
    private PApplet labelBox;

    public ButtonUpgradeDamage(ReadJson readJson, String text, String label, int button_x, int button_y, int button_w, int button_h, PApplet block) {
    ...
    public boolean keyPressed() {
        if (tmp) {
            if (block.keyPressed && block.key == '3') {
                click = !click;
            } 
