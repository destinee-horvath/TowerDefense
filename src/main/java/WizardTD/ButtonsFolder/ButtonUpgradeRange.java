...
public class ButtonUpgradeRange extends Buttons {
    private PApplet labelBox;

    public ButtonUpgradeRange(ReadJson readJson, String text, String label, int button_x, int button_y, int button_w, int button_h, PApplet block) {
    ...
    public boolean keyPressed() {
        if (tmp) {
            if (block.keyPressed && block.key == '1') {
                click = !click;
            } 
